...
param(
    ...
    [string]$ResultsPath = "..\\results\\improved_coverage_results.csv",
...
python $pythonScript `
    ...
    --test-stage improved `
    --test-file-name DatasetImprovedTest.java `
    --test-class-name DatasetImprovedTest `
    --artifacts-subdir improved-coverage
