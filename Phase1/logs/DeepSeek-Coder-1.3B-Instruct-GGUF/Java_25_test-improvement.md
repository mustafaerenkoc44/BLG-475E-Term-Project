...
- **Task:** `Java/25` (folder `Java_025_factorize`)
- **Step:** `test-improvement`
- **Base artifact:** `tasks/Java_025_factorize/generated-tests/improved/DeepSeek-Coder-1.3B-Instruct-GGUF/DatasetImprovedTest.java`
...
Target: factorize in tasks/Java_025_factorize/generated-code/DeepSeek-Coder-1.3B-Instruct-GGUF/Solution.java.
...
at logs/DeepSeek-Coder-1.3B-Instruct-GGUF/Java_25_test-improvement.raw.txt when available;
...
- `improvedLargeRepeatedFactorCount_B2` - covers an equivalence / boundary class flagged as 'No' or 'Partially' in equivalence_classes.md
- `improvedSquareOfPrime_V2` - covers an equivalence / boundary class flagged as 'No' or 'Partially' in equivalence_classes.md
- `improvedCompositeWithDistinctPrimes_V3` - covers an equivalence / boundary class flagged as 'No' or 'Partially' in equivalence_classes.md
- `improvedMutationBelowTwoReturnsEmptyList_I1_I2` - mutation-based guard (see docs/analysis/mutation_testing_strategy.md)
...
compile_success=true and junit_success=true for (Java_025_factorize, DeepSeek-Coder-1.3B-Instruct-GGUF).
