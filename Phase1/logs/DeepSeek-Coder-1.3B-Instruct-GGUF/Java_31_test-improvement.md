...
- **Task:** `Java/31` (folder `Java_031_isPrime`)
- **Step:** `test-improvement`
- **Base artifact:** `tasks/Java_031_isPrime/generated-tests/improved/DeepSeek-Coder-1.3B-Instruct-GGUF/DatasetImprovedTest.java`
...
Target: isPrime in tasks/Java_031_isPrime/generated-code/DeepSeek-Coder-1.3B-Instruct-GGUF/Solution.java.
...
|---|---|---|---|---|
| V1 | Small prime number. | `n=2` | Yes (improved) | Smallest prime boundary. |
...
| I2 | Negative integer. | `n=-7` | Yes (improved) | Out of contract but useful for robustness notes. |

## Boundary Conditions

| Class ID | Description | Representative Input | Covered By Existing Test? | Notes |
|---|---|---|---|---|
| B1 | Perfect square of a prime. | `n=49` | Yes (improved) | Important divisor-loop boundary. |
...
at logs/DeepSeek-Coder-1.3B-Instruct-GGUF/Java_31_test-improvement.raw.txt when available;
...
- `improvedSmallestPrime_V1` - covers an equivalence / boundary class flagged as 'No' or 'Partially' in equivalence_classes.md
- `improvedPerfectSquareOfPrimeRejected_B1` - covers an equivalence / boundary class flagged as 'No' or 'Partially' in equivalence_classes.md
- `improvedBoundaryZeroIsNotPrime_I1` - covers an equivalence / boundary class flagged as 'No' or 'Partially' in equivalence_classes.md
- `improvedMutationNegativeInputsAreNotPrime_I2` - mutation-based guard (see docs/analysis/mutation_testing_strategy.md)
...
compile_success=true and junit_success=true for (Java_031_isPrime, DeepSeek-Coder-1.3B-Instruct-GGUF).
