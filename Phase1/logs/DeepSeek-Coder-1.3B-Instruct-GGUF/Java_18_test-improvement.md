...
- **Task:** `Java/18` (folder `Java_018_howManyTimes`)
- **Step:** `test-improvement`
- **Base artifact:** `tasks/Java_018_howManyTimes/generated-tests/improved/DeepSeek-Coder-1.3B-Instruct-GGUF/DatasetImprovedTest.java`
...
Target: howManyTimes in tasks/Java_018_howManyTimes/generated-code/DeepSeek-Coder-1.3B-Instruct-GGUF/Solution.java.
...
at logs/DeepSeek-Coder-1.3B-Instruct-GGUF/Java_18_test-improvement.raw.txt when available;
...
- `improvedFullStringMatch_B2_V3` - covers an equivalence / boundary class flagged as 'No' or 'Partially' in equivalence_classes.md
- `improvedOverlappingLongerSubstring_V3` - covers an equivalence / boundary class flagged as 'No' or 'Partially' in equivalence_classes.md
- `improvedSubstringLongerThanSource_B1` - covers an equivalence / boundary class flagged as 'No' or 'Partially' in equivalence_classes.md
- `improvedMutationEmptySubstringCountsPositions_I1` - mutation-based guard (see docs/analysis/mutation_testing_strategy.md)
...
compile_success=true and junit_success=true for (Java_018_howManyTimes, DeepSeek-Coder-1.3B-Instruct-GGUF).
