...
- **Base artifact:** `tasks/Java_002_truncateNumber/generated-tests/improved/DeepSeek-Coder-1.3B-Instruct-GGUF/DatasetImprovedTest.java`
...
Target: truncateNumber in tasks/Java_002_truncateNumber/generated-code/DeepSeek-Coder-1.3B-Instruct-GGUF/Solution.java.
...
at logs/DeepSeek-Coder-1.3B-Instruct-GGUF/Java_2_test-improvement.raw.txt when available;
...
- `improvedMutationNegativeInputsDeepSeekCastSemantics_V2` - mutation-based guard (see docs/analysis/mutation_testing_strategy.md)
...
compile_success=true and junit_success=true for (Java_002_truncateNumber, DeepSeek-Coder-1.3B-Instruct-GGUF).
