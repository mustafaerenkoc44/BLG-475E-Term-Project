...
- **Base artifact:** `tasks/Java_021_rescaleToUnit/generated-tests/improved/Qwen2.5-Coder-1.5B-Instruct-GGUF/DatasetImprovedTest.java`
...
Target: rescaleToUnit in tasks/Java_021_rescaleToUnit/generated-code/Qwen2.5-Coder-1.5B-Instruct-GGUF/Solution.java.
...
at logs/Qwen2.5-Coder-1.5B-Instruct-GGUF/Java_21_test-improvement.raw.txt when available;
...
- `improvedAlreadySpansUnitInterval_B2` - covers an equivalence / boundary class flagged as 'No' or 'Partially' in equivalence_classes.md
...
compile_success=true and junit_success=true for (Java_021_rescaleToUnit, Qwen2.5-Coder-1.5B-Instruct-GGUF).
