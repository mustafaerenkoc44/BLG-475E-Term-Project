...
- **Base artifact:** `tasks/Java_001_separateParenGroups/generated-tests/improved/Qwen2.5-Coder-1.5B-Instruct-GGUF/DatasetImprovedTest.java`
...
Target: separateParenGroups in tasks/Java_001_separateParenGroups/generated-code/Qwen2.5-Coder-1.5B-Instruct-GGUF/Solution.java.
...
at logs/Qwen2.5-Coder-1.5B-Instruct-GGUF/Java_1_test-improvement.raw.txt when available;
...
- `improvedMutationUnbalancedInputYieldsPartialOutput_I1` - mutation-based guard (see docs/analysis/mutation_testing_strategy.md)
...
compile_success=true and junit_success=true for (Java_001_separateParenGroups, Qwen2.5-Coder-1.5B-Instruct-GGUF).
