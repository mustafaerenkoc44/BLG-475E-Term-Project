...
- **Base artifact:** `tasks/Java_019_sortNumbers/generated-tests/improved/Qwen2.5-Coder-1.5B-Instruct-GGUF/DatasetImprovedTest.java`
...
Target: sortNumbers in tasks/Java_019_sortNumbers/generated-code/Qwen2.5-Coder-1.5B-Instruct-GGUF/Solution.java.
...
at logs/Qwen2.5-Coder-1.5B-Instruct-GGUF/Java_19_test-improvement.raw.txt when available;
...
- `improvedWhitespaceOnlyInputYieldsEmpty_B1` - covers an equivalence / boundary class flagged as 'No' or 'Partially' in equivalence_classes.md
- `improvedMutationUnknownTokenSortsFirst_I1` - mutation-based guard (see docs/analysis/mutation_testing_strategy.md)
...
compile_success=true and junit_success=true for (Java_019_sortNumbers, Qwen2.5-Coder-1.5B-Instruct-GGUF).
