...
- **Base artifact:** `tasks/Java_006_parseNestedParens/generated-tests/improved/Qwen2.5-Coder-1.5B-Instruct-GGUF/DatasetImprovedTest.java`
...
Target: parseNestedParens in tasks/Java_006_parseNestedParens/generated-code/Qwen2.5-Coder-1.5B-Instruct-GGUF/Solution.java.
...
at logs/Qwen2.5-Coder-1.5B-Instruct-GGUF/Java_6_test-improvement.raw.txt when available;
...
- `improvedMutationUnbalancedInputYieldsMaxDepth_I1` - mutation-based guard (see docs/analysis/mutation_testing_strategy.md)
...
compile_success=true and junit_success=true for (Java_006_parseNestedParens, Qwen2.5-Coder-1.5B-Instruct-GGUF).
