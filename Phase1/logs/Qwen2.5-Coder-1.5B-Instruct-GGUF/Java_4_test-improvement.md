...
- **Base artifact:** `tasks/Java_004_meanAbsoluteDeviation/generated-tests/improved/Qwen2.5-Coder-1.5B-Instruct-GGUF/DatasetImprovedTest.java`
...
Target: meanAbsoluteDeviation in tasks/Java_004_meanAbsoluteDeviation/generated-code/Qwen2.5-Coder-1.5B-Instruct-GGUF/Solution.java.
...
at logs/Qwen2.5-Coder-1.5B-Instruct-GGUF/Java_4_test-improvement.raw.txt when available;
...
- `improvedMutationEmptyListFallsBackToZeroForQwenStreamSemantics_I1` - mutation-based guard (see docs/analysis/mutation_testing_strategy.md)
...
compile_success=true and junit_success=true for (Java_004_meanAbsoluteDeviation, Qwen2.5-Coder-1.5B-Instruct-GGUF).
