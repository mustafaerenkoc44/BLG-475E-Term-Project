...
Selection reason: Prime factor multiplicity is good for mutation-style variations

## Status Snapshot

- `Qwen2.5-Coder-1.5B`: base `6/6 branches (100.00%)`, improved `6/6 branches (100.00%)`
