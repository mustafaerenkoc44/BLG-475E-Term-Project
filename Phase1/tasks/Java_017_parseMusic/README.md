...
Difficulty: hard
Domain: token-parsing
Phase 2 dependency: no
Selection reason: Multi-token decoding creates parsing and boundary risks

## Status Snapshot

- `Qwen2.5-Coder-1.5B`: base `9/10 branches (90.00%)`, improved `9/10 branches (90.00%)`
- `DeepSeek-Coder-1.3B`: base `6/6 branches (100.00%)`, improved `6/6 branches (100.00%)`
