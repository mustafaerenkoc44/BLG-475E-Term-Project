...
class DatasetImprovedTest {
    ...
    void improvedPreservesDigitsAndPunctuation_V3() {
        ...
        Assertions.assertEquals("123!aB", s.flipCase("123!Ab"),
                "Valid class V3: non-letter characters fall through and are appended unchanged");
    }
    ...
    void improvedEmptyStringIsPassThrough_B1() {
        ...
        Assertions.assertEquals("", s.flipCase(""),
                "Boundary B1: an empty input skips the per-character loop and returns an empty string");
    }
    ...
    void improvedMutationNullStringThrowsNpe_I1() {
        ...
        Assertions.assertThrows(NullPointerException.class,
                () -> s.flipCase(null),
                "Invalid class I1 (mutation): accessing a null string inside the loop raises an NPE");
    }
}
