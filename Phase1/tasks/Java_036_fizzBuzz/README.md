...
Difficulty: hard
Domain: combinational-logic
Phase 2 dependency: no
Selection reason: Digit counting plus divisibility creates hidden branches

## Status Snapshot

- `Qwen2.5-Coder-1.5B`: base `10/10 branches (100.00%)`, improved `10/10 branches (100.00%)`
- `DeepSeek-Coder-1.3B`: base `10/10 branches (100.00%)`, improved `10/10 branches (100.00%)`
