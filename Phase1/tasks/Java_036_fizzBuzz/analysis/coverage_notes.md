# Coverage Notes - Java/36

## Base Tests
- `Qwen2.5-Coder-1.5B` base coverage: `10` covered / `0` missed (100.00%)
...
### Smells Observed
- count jump around 77 is easy to miss
- first qualifying divisor boundary absent

## Improved Tests
- `Qwen2.5-Coder-1.5B` improved coverage: `10` covered / `0` missed (100.00%; delta +0.00%)
