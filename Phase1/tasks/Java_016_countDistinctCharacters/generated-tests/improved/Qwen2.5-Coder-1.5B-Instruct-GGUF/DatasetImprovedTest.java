...
class DatasetImprovedTest {
    ...
    void improvedWhitespaceAndPunctuationCountAsDistinct_V2() {
        ...
        Assertions.assertEquals(2, s.countDistinctCharacters("a A "),
                "Valid class V2: whitespace is a character too; 'a'/'A' collapse after toLowerCase, leaving the set { 'a', ' ' } with size 2");
    ...
    void improvedMutationNullStringThrowsNpe_I1() {
        ...
        Assertions.assertThrows(NullPointerException.class,
                ...
                "Invalid class I1 (mutation): calling toLowerCase on a null reference must throw NPE");
    }
}
