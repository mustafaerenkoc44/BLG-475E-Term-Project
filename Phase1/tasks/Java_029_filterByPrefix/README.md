# Java/29 - filterByPrefix

Difficulty: moderate
Domain: string-filtering
Phase 2 dependency: no
Selection reason: Complements substring filtering with prefix semantics

## Status Snapshot

- `Qwen2.5-Coder-1.5B`: base `N/A`, improved `N/A`
- `DeepSeek-Coder-1.3B`: base `N/A`, improved `N/A`
