...
class DatasetImprovedTest {
    ...
    @Test
    void improvedMutationEmptyListProducesNaNForDeepSeekDivisionBySize_I1() {
        Solution s = new Solution();
        // DeepSeek computes sum / numbers.size() which divides zero by zero on an empty list => NaN.
        Assertions.assertTrue(
                Double.isNaN(s.meanAbsoluteDeviation(new ArrayList<>())),
                "Invalid class I1 (mutation): plain division by size yields NaN on empty list, documenting the unsafe contract");
    }
}
